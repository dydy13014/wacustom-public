...
class KitsuService:
    ...
    async def get_metadata(self, kitsu_id: str) -> Optional[Dict]:
        ...
        try:
            ...
            metadata_logger.error(f"[Kitsu] Fetch error: {type(e).__name__}: {e}")
            return None
    ...
    async def _get_aliases(self, kitsu_id: str) -> List[str]:
        ...
        try:
            ...
            metadata_logger.error(f"[Kitsu] Aliases error: {type(e).__name__}: {e}")
    ...
    async def get_season_chain_and_mapping(self, kitsu_id: str, episode: int) -> Tuple[int, int, Dict, Optional[str], Optional[str], Optional[Dict]]:
        try:
            ...
            metadata_logger.error(f"[Kitsu] Season mapping error: {type(e).__name__}: {e}")
    ...
    async def _get_season_info(self, kitsu_id: str) -> Optional[Dict]:
        try:
            ...
            metadata_logger.error(f"[Kitsu] Season info error: {type(e).__name__}: {e}")
    ...
    async def _get_related_id(self, kitsu_id: str, role: str) -> Optional[str]:
        try:
            ...
            metadata_logger.error(f"[Kitsu] {role} error: {type(e).__name__}: {e}")
