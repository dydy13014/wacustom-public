...
class BaseDarkiAPI:
    ...
    async def _search_by_imdb_id(self, titles: List[str], metadata: Dict) -> Optional[Dict]:
        ...
        for search_title in titles:
            try:
                ...
                scraper_logger.error(f"[Darki-API] Title '{search_title}' search error: {type(e).__name__}: {e}")
                continue
    ...
    async def _search_by_name(self, titles: List[str], metadata: Dict) -> Optional[Dict]:
        ...
        for search_title in titles:
            try:
                ...
                scraper_logger.error(f"[Darki-API] Kitsu '{search_title}' search error: {type(e).__name__}: {e}")
                continue
    ...
    async def get_all_links(self, title_id: int, season: Optional[str] = None, episode: Optional[str] = None) -> List[Dict]:
        ...
        while True:
            try:
                ...
                scraper_logger.error(f"[Darki-API] Links page {page} fetch error: {type(e).__name__}: {e}")
                break
    ...
    async def get_all_nzb(self, title_id: int, season: Optional[str] = None, episode: Optional[str] = None) -> List[Dict]:
        ...
        while True:
            try:
                ...
                scraper_logger.error(f"[Darki-API] NZB page {page} fetch error: {type(e).__name__}: {e}")
                break
    ...
    async def verify_and_get_link(self, link_id: int) -> Optional[str]:
        ...
        try:
            ...
            scraper_logger.error(f"[Darki-API] Link {link_id} verification error: {type(e).__name__}: {e}")
            return None
    ...
    async def search_content(self, title: str, year: Optional[str] = None,
        ...
        try:
            ...
            scraper_logger.error(f"[Darki-API] {content_name.title()} search error: {type(e).__name__}: {e}")
            return []
    ...
    async def format_links(self, links: List[Dict], content_title: str, year: Optional[str] = None, is_series: bool = False, user_prefs: list = None) -> List[Dict]:
        ...
        for i, link in enumerate(links):
            try:
                ...
                scraper_logger.error(f"[Darki-API] Link format error: {type(e).__name__}: {e}")
                continue
    ...
    async def format_nzb(self, nzb_list: List[Dict], content_title: str, year: Optional[str] = None, is_series: bool = False, user_prefs: list = None) -> List[Dict]:
        ...
        for nzb in nzb_list:
            try:
                ...
                scraper_logger.error(f"[Darki-API] NZB format error: {type(e).__name__}: {e}")
                continue
    ...
    async def get_title_details(self, title_id: int) -> Optional[Dict]:
        ...
        try:
            ...
            scraper_logger.error(f"[Darki-API] Title details error: {type(e).__name__}: {e}")
            return None
